...
export async function sendMigrationEmail(email: string, name: string, country: string, username: string, tempPassword: string) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <img src="https://cujiware.com/logo.png" alt="Cujiware Logo" style="max-width: 200px; margin-bottom: 20px;">
      ...
      <ul>
        ...
        <li><strong>Sistema de Pagos Flexible:</strong> ${isVenezuela ? 'Pago móvile y Biopago en Venezuela' : 'Pagos con tarjeta a nivel internacional y automatizados con Stripe Subscriptions'}</li>
      ...
      <ol>
        ...
        ${!isVenezuela ? '<li>Vincula tu tarjeta de crédito para pagos automáticos</li>' : ''}
